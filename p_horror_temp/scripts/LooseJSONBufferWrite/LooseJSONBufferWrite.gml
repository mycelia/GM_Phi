...
function LooseJSONBufferWrite(_buffer, _value, _pretty = false, _alphabetise = false, _accurateFloats = false)
{
    return __ToLooseJSONBufferValue(_buffer, _value, _pretty, _alphabetise, _accurateFloats, "");
}

function __ToLooseJSONBufferValue(_buffer, _value, _pretty, _alphabetise, _accurateFloats, _indent)
{
    static _funcNumberToString = function(_value, _accurateFloats)
    {
    ...
    {
        buffer_write(_buffer, buffer_text, _funcNumberToString(_value, _accurateFloats));
    }
        ...
        else
        {
            if (_pretty)
            {
                ...
                repeat(_count)
                {
                    ...
                    __ToLooseJSONBufferValue(_buffer, _array[_i], _pretty, _alphabetise, _accurateFloats, _indent);
        ...
        else
        {
            if (_pretty)
            {
                ...
                repeat(_count)
                {
                    ...
                    buffer_write(_buffer, buffer_text, _indent);
                    __ToLooseJSONBufferValue(_buffer, _name, _pretty, _alphabetise, _accurateFloats, _indent);
                    buffer_write(_buffer, buffer_u16,  0x203A); // <: >
                    
                    __ToLooseJSONBufferValue(_buffer, _struct[$ _name], _pretty, _alphabetise, _accurateFloats, _indent);
