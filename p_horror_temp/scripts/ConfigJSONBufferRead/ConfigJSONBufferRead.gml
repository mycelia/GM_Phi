...
function ConfigJSONBufferRead(_buffer, _inOffset = undefined)
{
    ...
    while(buffer_tell(_buffer) < _bufferSize)
    {
        ...
        {
            __BufferReadConfigJSONComment(_buffer, _bufferSize);
        }
        else if ((_byte == ord("/")) && (buffer_peek(_buffer, buffer_tell(_buffer), buffer_u8) == ord("*")))
        {
            __BufferReadConfigJSONMultilineComment(_buffer, _bufferSize);
        }
        else if (_byte == ord("["))
        {
            _result = __BufferReadConfigJSONArray(_buffer, _bufferSize);
        }
        else if (_byte == ord("{"))
        {
            _result = __BufferReadConfigJSONStruct(_buffer, _bufferSize);
        }
        else if (_byte > 0x20)
        {
...
function __BufferReadConfigJSONArray(_buffer, _bufferSize)
{
    var _result = [];
    ...
    while(buffer_tell(_buffer) < _bufferSize)
    {
        ...
        {
            var _value = __BufferReadConfigJSONValue(_buffer, _bufferSize, _byte);
...
function __BufferReadConfigJSONStruct(_buffer, _bufferSize)
{
    var _result = {};
    ...
    while(buffer_tell(_buffer) < _bufferSize)
    {
        ...
        {
            var _key = __BufferReadConfigJSONValue(_buffer, _bufferSize, _byte);
            ...
            if (is_string(_key))
            {
                __BufferReadConfigJSONStructMerge(_result, _key, _value);
            }
            else //Is an array
            {
                //Use the original return value to set the first key
                __BufferReadConfigJSONStructMerge(_result, _keyArray[0], _value);
                ...
                repeat(_keyArrayLength-1)
                {
                    ...
                    __BufferReadConfigJSONStructMerge(_result, _key, __BufferReadConfigJSONDeepCopyInner(_value, self, self));
                    ++_i;
                }
            }
...
function __BufferReadConfigJSONStructMerge(_rootStruct, _key, _newValue)
{
        ...
        else if (is_struct(_oldValue))
        {
            if (is_struct(_newValue))
            {
                ...
                repeat(array_length(_variableNameArray))
                {
                    ...
                    __BufferReadConfigJSONStructMerge(_oldValue, _variableName, _newValue[$ _variableName]);
                    ++_i;
                }
...
function __BufferReadConfigJSONValue(_buffer, _bufferSize, _firstByte)
{
    if (_firstByte == ord("["))
    {
        return __BufferReadConfigJSONArray(_buffer, _bufferSize);
    }
    else if (_firstByte == ord("{"))
    {
        return __BufferReadConfigJSONStruct(_buffer, _bufferSize);
    }
    else if (_firstByte == ord("\""))
    {
        return __BufferReadConfigJSONDelimitedString(_buffer, _bufferSize);
    }
    else
    {
        return __BufferReadConfigJSONString(_buffer, _bufferSize);
    }
}

function __BufferReadConfigJSONDelimitedString(_buffer, _bufferSize)
{
...
function __BufferReadConfigJSONString(_buffer, _bufferSize)
{
    static _cacheBuffer = buffer_create(1024, buffer_grow, 1);
    buffer_seek(_cacheBuffer, buffer_seek_start, 0);
...
function __BufferReadConfigJSONComment(_buffer, _bufferSize)
{
    while(buffer_tell(_buffer) < _bufferSize)
    {
        var _byte = buffer_read(_buffer, buffer_u8);
...
function __BufferReadConfigJSONMultilineComment(_buffer, _bufferSize)
{
    while(buffer_tell(_buffer) < _bufferSize)
    {
        var _byte = buffer_read(_buffer, buffer_u8);
...
function __BufferReadConfigJSONDeepCopyInner(_value, _oldStruct, _newStruct)
{
    var _copy = _value;
    ...
    else if (is_struct(_value))
    {
        ...
        repeat(array_length(_namesArray))
        {
            ...
            _copy[$ _name] = __BufferReadConfigJSONDeepCopyInner(_value[$ _name], _value, _copy);
            ++_i;
        }
    }
    else if (is_array(_value))
    {
        ...
        repeat(_count)
        {
            _copy[@ _i] = __BufferReadConfigJSONDeepCopyInner(_value[_i], _oldStruct, _newStruct);
            ++_i;
        }
    }
