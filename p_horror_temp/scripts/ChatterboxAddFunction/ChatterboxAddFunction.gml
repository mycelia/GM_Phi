...
///         <<endif>>
/// 
/// This example shows how the script am_i_dead() is called by Chatterbox in an if statement. The
/// value returned from am_i_dead() determines which text is displayed.
/// 
/// Parameters for custom functions executed by ChatterScript script should be separated by
/// spaces. The parameters are passed into the given function as an array of values as argument0.
/// 
...
function ChatterboxAddFunction(_name, _in_function)
{
    ...
    var _old_function = _system.__functionsMap[? _name];
